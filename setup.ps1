...
# using function
Install-ADDS -ENTREE_DOMAINE_NAME $ENTREE_DOMAIN -IP_HOST $ENTREE_IP_HOST -IP_ROUTER $ENTREE_IP_ROUTER -SAFE_PASSWORD $ENTREE_SAFE_PASSWORD
Import-BulkOU -ENTREE_DOMAIN_NAME $ENTREE_DOMAIN -PATH_CSV $IMPORT_OU
Import-BulkGroup -ENTREE_DOMAIN_NAME $ENTREE_DOMAIN -PATH_CSV $IMPORT_GRP
Import-BulkUser -ENTREE_DOMAIN_NAME $ENTREE_DOMAIN -PATH_CSV $IMPORT_USER
